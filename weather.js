...
function parseCurrentWeather({current_weather , daily}){
  ...
  const{ 
    ...
    const{
      ...
      apparent_temperature_max:[maxFellsLike],
      apparent_temperature_min:[minFellsLike],
  ...
  return {
    ...
    highFellsLike:Math.round(maxFellsLike),
    lowFellsLike:Math.round(minFellsLike),
    windSpeed:Math.round(windSpeed),
    precipt: Math.round(precip * 100) /100,
    iconCode,
  }
}
